...
import 'package:flutter_samples/MED_REMINDER/models/errors.dart';
import 'package:flutter_samples/MED_REMINDER/models/medicine.dart';
import 'package:flutter_samples/MED_REMINDER/pages/new_entry/new_entry_bloc.dart';
import 'package:flutter_samples/MED_REMINDER/pages/success_screen/success_screen.dart';
...
class _NewEntryPageState extends State<NewEntryPage> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: GestureDetector(
        onTap: () {
          ...
          List<int> intIDs = makeIDs(24 / _newEntryBloc.selectIntervals!.value);
          List<String> notificationIDs =
              intIDs.map((i) => i.toString()).toList();
  ...
  Future<void> scheduleNotification(Medicine medicine) async {
    ...
    var androidPlatformChannelSpecifics = const AndroidNotificationDetails(
      ...
      enableLights: true,
      // playSound: true,
      // sound: RawResourceAndroidNotificationSound('assets/sound/sound.mp3')
    );
