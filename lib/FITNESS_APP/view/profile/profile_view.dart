...
class _ProfileViewState extends State<ProfileView> {
  final String height = '', weight = '', age = '';
              ...
              Row(
                children: [
                  Obx(
                    () => Expanded(
                      child: TitleSubtitleCell(
                        title: controller.userHeight.value.toString(),
                        subtitle: "Height",
                      ),
                    ),
                  ),
                  ...
                  Obx(
                    () => Expanded(
                      child: TitleSubtitleCell(
                        title: controller.userWeight.value.toString(),
                        subtitle: "Weight",
                      ),
                    ),
                  ),
                  ...
                  Obx(
                    () => Expanded(
                      child: TitleSubtitleCell(
                        title: '${controller.userAge.value.toString()} yo',
                        subtitle: "Age",
                      ),
                    ),
                  ),
